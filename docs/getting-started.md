...
```bash
export PULUMI_EVENTS_MEETUP_CLIENT_ID="your-client-id"
export PULUMI_EVENTS_MEETUP_CLIENT_SECRET="your-client-secret"
```
...
| `PULUMI_EVENTS_MEETUP_GRAPHQL_ENDPOINT` | `https://api.meetup.com/gql-ext` | Meetup GraphQL API URL |
